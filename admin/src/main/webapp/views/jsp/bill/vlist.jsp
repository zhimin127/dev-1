...
<div class="content">
    ...
    <!-- Sidebar ends -->
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="icon-table"></i> 账单列表</h2>

        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
          <a href="index.html"><i class="icon-home"></i> 账单</a> 
          <!-- Divider -->
              ...
              <div class="col-md-12">
                ...
                <div class="widget-head">
                  ...
                  <div class="widget-icons pull-right">
                    <a href="javascript:void(0)" class=""><i class="icon-vk"></i></a>
                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						<c:forEach var="bill" items="${rows}">
                        <tr>
                          <td>${bill.id}</td>
                          <td>${bill.costTypeName}</td>
                          <td>${bill.costName}</td>
                          <td>${bill.costMoney}</td>
                          <td>${bill.costTime}</td>
